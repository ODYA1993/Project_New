...
class OrderForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):            # отображение поля на русс
        super().__init__(*args, **kwargs)
        self.fields['order_date'].label = 'Дата получения заказа'
    
    order_date = forms.DateField(widget=forms.TextInput(attrs={'type': 'date'}))        # выпадающее поля даты
...
class LoginForm(forms.ModelForm):
    ...
    password = forms.CharField(widget=forms.PasswordInput)      # что-бы при вводе пароля были символы
